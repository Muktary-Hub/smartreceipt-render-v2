...
const puppeteer = require('puppeteer'); // Use the full package
...
// [All helper functions and server routes are unchanged]
// ...
...
async function initializeBrowser() {
    try {
        browser = await puppeteer.launch({
            // No executablePath. Let Puppeteer find its own browser.
            headless: true,
